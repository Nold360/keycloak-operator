...
func getSecurityContext(secctx *v1.PodSecurityContext) *v1.PodSecurityContext {
	if secctx != nil {
		return secctx
	}
		...
		Spec: v13.StatefulSetSpec{
			...
			Template: v1.PodTemplateSpec{
				...
				Spec: v1.PodSpec{
					...
					SecurityContext:    getSecurityContext(cr.Spec.KeycloakDeploymentSpec.SecurityContext),
				},
			},
		},
	}
...
func KeycloakDeploymentReconciled(cr *v1alpha1.Keycloak, currentState *v13.StatefulSet, dbSecret *v1.Secret, dbSSLSecret *v1.Secret) *v13.StatefulSet {
	...
	reconciled.Spec.Template.Spec.SecurityContext = getSecurityContext(cr.Spec.KeycloakDeploymentSpec.SecurityContext)
